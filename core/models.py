...
class UserProfile(AbstractUser):
   ...
   ventanillas_atencion = models.ManyToManyField('Ventanilla', blank=True, related_name='usuarios')
   perfil = models.ForeignKey('Perfil', on_delete=models.SET_NULL, blank=True, null=True, related_name='usuarios')
...
class Perfil(models.Model):
    ...
    tipo_seleccion = models.CharField(max_length=20, choices=[
        ('MANUAL', 'Manual'),
...
class Tramite(models.Model):
   ...
   cliente_requerido = models.CharField(max_length=50, choices=[
   ...
   ventanilla_atencion = models.ForeignKey('core.Ventanilla', on_delete=models.SET_NULL, null=True, related_name='tramites_atencion')
   ventanilla_transferencia_frecuente = models.ManyToManyField('core.Ventanilla', blank=True, related_name='tramites_transferencia_frecuente')
   grupo_transferencia_frecuente = models.ManyToManyField('core.Grupo', blank=True, related_name='tramites_grupo_transferencia_frecuente')
...
class Grupo(models.Model):
  ...
  """
  nombre = models.CharField(max_length=100)
  ventanillas_atencion = models.ManyToManyField('core.Ventanilla', related_name='grupos')
  estado = models.BooleanField(default=True)
