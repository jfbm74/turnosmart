...
from .views import PasswordChangeView, PasswordResetConfirmView, PasswordResetRequestView, UserRegister, UserLogin, UserProfileView, UserLogoutView, UserCreateView
