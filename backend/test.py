...
class SwaggerEndpointTests(TestCase):
    ...
    def test_swagger_endpoint(self):
        ...
        self.assertIn(
            '<div id="swagger-ui">', response.content.decode("utf-8")
        )  # Verifica el elemento de Swagger
    ...
    def test_redoc_endpoint(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertIn(
            '<div id="redoc-placeholder">', response.content.decode("utf-8")
        )  # Verifica el elemento de ReDoc
