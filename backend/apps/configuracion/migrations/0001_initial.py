    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timbre', models.FileField(blank=True, null=True, upload_to='audios/')),
            ],
        ),
        migrations.CreateModel(
            name='Imagen',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('logo_pequeño', models.ImageField(blank=True, null=True, upload_to='images/')),
                ('logo_grande', models.ImageField(blank=True, null=True, upload_to='images/')),
                ('logo_ticket', models.ImageField(blank=True, null=True, upload_to='images/')),
                ('footer', models.ImageField(blank=True, null=True, upload_to='images/')),
                ('wallpaper_turnero', models.ImageField(blank=True, null=True, upload_to='images/')),
            ],
        ),
        migrations.CreateModel(
            name='Institucion',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('copyright', models.CharField(default='jairo blanquiceth', max_length=200)),
                ('contrasena_email_notificaciones', models.CharField(blank=True, default='a', max_length=200, null=True)),
                ('puerto_notificaciones', models.IntegerField(blank=True, default=587, null=True)),
                ...
                ('emision_ticket', models.CharField(choices=[('IMPRIMIR', 'Imprimir'), ('QR', 'QR')], default='IMPRIMIR', max_length=20)),
                ('url_copyright', models.URLField(blank=True, default='https://piisa.com', null=True)),
                ('email_notificaciones', models.EmailField(blank=True, default='jairoblanquicethcuello@gmail.com', max_length=254, null=True)),
                ('host_notificaciones', models.CharField(blank=True, default='smtp.gmail.com', max_length=200, null=True)),
                ('remitente_notificaciones', models.CharField(blank=True, default='Socioturnos', max_length=200, null=True)),
                ('enlace_recuperacion_clave', models.URLField(blank=True, default='http://socioturnos.com/digiturnos/recuperarclave.php', null=True)),
                ('enlace_encuesta', models.URLField(blank=True, default='http://socioturnos.com/digiturnos/encuesta.php', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Ticket',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('origen', models.CharField(choices=[('URL', 'URL Externa'), ('SISTEMA', 'Videos subidos en el sistema')], default='URL', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('origen_voz', models.CharField(choices=[('TTS NAVEGADOR WEB', 'TTS NAVEGADOR WEB'), ('URL EXTERNA', 'URL Externa')], default='TTS NAVEGADOR WEB', max_length=20)),
                ('idioma', models.CharField(default='ESPAÑOL (ESPAÑA)', max_length=200)),
