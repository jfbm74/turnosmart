...
class Espera(models.Model):
    ...
    """
    etiquetas_llamado_individual_multiple = models.TextField(default="""{turno}: Número de turno completo.
    ...
    llamado_sala_espera_individual = models.CharField(max_length=300, default='@ turno. {turno_dividido} {cedula_existe_inicio} con documento {cedula_existe_cierre} {cedula} pase a. {ventanilla}', blank=True, null=True)
    llamado_sala_espera_multiple_parte1 = models.CharField(max_length=300, default='@ Turnos.', blank=True, null=True)
    llamado_sala_espera_multiple_parte2 = models.CharField(max_length=300, default='@ {turno_dividido}', blank=True, null=True)
    llamado_sala_espera_multiple_parte3 = models.CharField(max_length=300, default='@ pasen a. {ventanilla}', blank=True, null=True)
    titulo_columna_turnos = models.CharField(max_length=50, default='TURNO', blank=True, null=True)
